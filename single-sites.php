                            ...
                            <div class="col-12 col-sm-8 col-lg-5 mt-4 mt-md-0">
                                <div class="site-body p-xl-4">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <?php if ($m_link_url != ""): ?>
                                        <a style="margin-right: 10px;" href="<?php echo io_get_option('is_go') ? home_url() . '/go/?url=' . $m_link_url : $m_link_url ?>" title="<?php echo $sitetitle ?>" target="_blank" class="btn btn-arrow"><span><?php _e('Visit site', 'i_theme') ?><i class="fa fa-angle-right"></i></span></a>
                                        <?php endif; ?>
